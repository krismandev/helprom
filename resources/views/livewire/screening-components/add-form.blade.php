                                ...
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <div
                                            ...
                                            <div
                                                class="step {{ ($form == 2 or $form == 3 or $form == 4 or $form == 5 or $form == 6 or $form == 7 or $form == 8) ? 'completed' : '' }} }}">
                                                <div class="step-icon-wrap">
                                            ...
                                            <div
                                                class="step {{ ($form == 3 or $form == 4 or $form == 5 or $form == 6 or $form == 7 or $form == 8) ? 'completed' : '' }} }}">
                                                <div class="step-icon-wrap">
                                            ...
                                            <div
                                                class="step {{ ($form == 4 or $form == 5 or $form == 6 or $form == 7 or $form == 8) ? 'completed' : '' }} }}">
                                                <div class="step-icon-wrap">
                                            ...
                                            <div
                                                class="step {{ ($form == 5 or $form == 6 or $form == 7 or $form == 8) ? 'completed' : '' }} }}">
                                                <div class="step-icon-wrap">
