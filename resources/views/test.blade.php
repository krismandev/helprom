...
@section('css')
    ...
    <link rel="stylesheet"
        href="{{ url('') }}/asset/dashboard/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css">
    ...
    <link rel="stylesheet"
        href="{{ url('') }}/asset/dashboard/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css">
    <!-- Bootstrap4 Duallistbox -->
    <link rel="stylesheet"
        href="{{ url('') }}/asset/dashboard/plugins/bootstrap4-duallistbox/bootstrap-duallistbox.min.css">
    <!-- Theme style -->
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" disabled="disabled" style="width: 100%; height: 100%;">
...
@section('script')
    ...
    <!-- Bootstrap4 Duallistbox -->
    <script src="{{ url('') }}/asset/dashboard/plugins/bootstrap4-duallistbox/jquery.bootstrap-duallistbox.min.js">
    </script>
    <!-- InputMask -->
    <script src="{{ url('') }}/asset/dashboard/plugins/moment/moment.min.js"></script>
    <script src="{{ url('') }}/asset/dashboard/plugins/inputmask/min/jquery.inputmask.bundle.min.js"></script>
    <!-- date-range-picker -->
    <script src="{{ url('') }}/asset/dashboard/plugins/daterangepicker/daterangepicker.js"></script>
    <!-- bootstrap color picker -->
    <script src="{{ url('') }}/asset/dashboard/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js">
    </script>
    <!-- Tempusdominus Bootstrap 4 -->
    <script
        src="{{ url('') }}/asset/dashboard/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js">
    </script>
    <!-- Bootstrap Switch -->
    <script src="{{ url('') }}/asset/dashboard/plugins/bootstrap-switch/js/bootstrap-switch.min.js"></script>
    <!-- AdminLTE App -->
