...
<head>
    ...
    <!-- overlayScrollbars -->
    <link rel="stylesheet"
        href="{{ url('') }}/asset/dashboard/plugins/overlayScrollbars/css/OverlayScrollbars.min.css">
    <!-- Daterange picker -->
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="{{ url('') }}/asset/dashboard/images/logo.png" alt="Helprom Logo"
    ...
    <!-- overlayScrollbars -->
    <script src="{{ url('') }}/asset/dashboard/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js">
    </script>
    <!-- AdminLTE App -->
